...
var addrowdirect = 0;
function addrow1(obj, type,parentid) {
	
	var table = obj.parentNode.parentNode.parentNode.parentNode.parentNode;
	var num = generateMixed(5);
	var rowtypedata = [
	[[1, '<input type="hidden" name="id[]" value="'+num+'" /><input name="order['+num+']" type="text" class="BigInput" value="999" style="width:40px;" />'], [1,'<input name="name['+num+']" type="text" class="BigInput" value="" size="40" />', 'td25'], [2, '<div><a href="javascript:;" class="deleterow" onClick="deleterow(this)">删除</a></div>']],
		[[1, '<input type="hidden" name="parentid['+num+']" value="'+parentid+'" /><input type="hidden" name="id[]" value="'+num+'" /><input name="order['+num+']" type="text" class="BigInput" value="999" style="width:40px;" />'], [1,'<input name="name['+num+']" type="text" class="BigInput" value="" size="40" />', 'td25'], [2, '<div><a href="javascript:;" class="deleterow" onClick="deleterow(this)">删除</a></div>']],
	];
	//alert(parentid);
	if(!addrowdirect) {
