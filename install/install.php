...
if ( file_exists($lockfile) ) {
	$error = true;
	$message = '<p>Ver似乎已经安装过了，请删除 install 文件夹下的所有文件。<br /><br />如果你想重新安装本程序，请先删除 cache 文件夹下的 install.lock 文件，再运行安装程序。</p>';
}
...
版权所有 (C)2017-2018 ck.cn 保留所有权利。

软件版本管理系统V1.1是由上海琛坤发展科技有限公司(软件版本管理系统V1.1)独立开发的基于PHP+MySQL的OA系统。软件版本管理系统V1.1为开放式管理系统，免费供大家使用，学习，交流， 任何人都可以从互联网上免费下载，并可以在不违反本协议规定和非商业用途的前提下进行使用。
开发商：上海琛坤发展科技有限公司 
开发团队：软件版本管理系统软件组
...
3、请务必仔细阅读本授权协议，在您同意授权协议的全部条件后，即可继续TOA的安装。即：您一旦开始安装TOA，即被视为完全同意本授权协议的全部内容，如果出现纠纷，我们将根据相关法律和协议条款追究责任。
	...
	<?php elseif ( $step == 6 ) :?>
		...
		<tr>
			<td align="center">
				<p>恭喜，软件版本管理系统V1.1安装成功！</p>
				<p>管理员帐号：<?php echo $username?> 管理员密码：<?php echo $password?></p>
				<p><a href="../login.php">点击这里进入软件版本管理系统V1.1</a></p>
			</td>
		</tr>
	<?php endif;?>
	</table>
...
<p id="copyright">Copyright &copy; 2009-2016  <a href="http://www.oa.cn" target="_blank">上海琛坤发展科技有限公司</a> All Rights Reserved.</p>
</body>
</html>