...
<div class="tabbable work-nav"> <!-- Only required for left/right tabs -->
				<ul id="myTab" class="nav nav-tabs">
					<li class="active"><a href="admin.php?ac=receive&fileurl=sms" data-toggle="tab">消息接收列表</a></li>
					<li><a href="admin.php?ac=index&fileurl=sms" data-toggle="tab">消息发送列表</a></li>
				</ul>
			</div>
...
<button type="button" onClick="updateform(2);" action="cancel_concern" class="btn btn-info">标志为己读</button>
